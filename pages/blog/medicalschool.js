...
import medicalschool from "../../public/images/medicalschool.png"

export default function MedicalSchool({ postsArr }) {
        ...
        <div>
            ...
            <div className={aboutStyles.header}>
                <div className={aboutStyles.about_container}>
                    <Image src={medicalschool} alt="About Page" width="500" height="98.8" />
                </div>
            </div>
...
export function getStaticProps() {
    ...
    for (let i = 0; i < fileArr.length; i++) {
        ...
        if (data.tags.includes("medicalschool")) {
